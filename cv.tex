...
\begin{multicols}{2}
\textsc{Data Science}\\
Artificila Inteligence, Deep Learning, \\Computer Vision, Big Data.\\
...
\years{2008.02 2014.11}\textsc{B.S.} in Physics, Universidad Distrital Francisco José de Caldas - Bogotá, Colombia, “Computational software development for the study of circuits with memristive elements". Advisor: Julian Salamanca Bernal.\\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\years{2024.11 Present}\textsc{Full-Time Faculty}. Tecnológico de Monterrey (Campus Guadalajara). Physics.\\

\years{2023.09 Present}\textsc{Adjunct Professor}. Fundación Universidad de América. Data Analytics, Big Data Analytics.\\
...
\years{2015.01 2015.11}\textsc{Adjunct Professor}. Universidad de Los Andes. Experimental Physics I,  
...
Instrument - DESI }} member collaborator. Data, Galaxy and Quasars Physics, and Anomaly Detection Working Groups.\\
...
\years{2021.05 Present}\textsc{Member}, \textit{ \href{https://www.astroreca.org/en/committeementors}{ 
...
\years{2020.04 2021.12\\ \\2023.05 Present}\textsc{Editor and Tutor}, \textit{\href{https://github.com/michaelJwilson/desihigh}{DESI High: School of the Dark Universe}} initiative of the Educational and Public Outreach (EPO) working group, a project of DESI members focusing on introducing DESI to high schoolers through introductory notebooks in Google Colab written in Python Language.
