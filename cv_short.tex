...
\geometry{a4paper, textwidth=5.5in, textheight=9in, marginparsep=6pt, marginparwidth=.6in}
...
\begin{multicols}{2}
[
{\LARGE John F. Suárez-Pérez}
]
Ph.D. in Science - Physics\\
Guadalajara, Jalisco - México\\
\href{mailto:jf.suarez@tec.mx}{jf.suarez@tec.mx}\\
+52 3327980765

\columnbreak

\hspace{-1cm}| \href{https://jsuarez314.gitlab.io}{Website} 
| \href{https://github.com/jsuarez314}{Github} 
| \href{https://shorturl.at/1Pcpt}{NASA/ADS} 
| \href{https://scholar.google.com/citations?user=_Z9iT9sAAAAJ}{Google Scholar} |
\end{multicols}
...
\begin{multicols}{2}
\textsc{Data Science}\\
Artificial Intelligence, Deep Learning, \\Computer Vision, Big Data.

\columnbreak
\textsc{Cosmology and Astronomy}\\
Large Scale Structure, Lyman Alpha Forest, Galaxy Evolution.
\end{multicols}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{Teaching}
\years{2024.11 Present}\textsc{Full-Time Faculty}. Tecnólogico de Monterrey ()Campus Guadalajara). Physics.\\

\years{2023.09 2024.08}\textsc{Adjunct Professor}. Universidad de América. Data Analytic, Big Data Analytic.\\

\years{2018.01 2023.08}\textsc{Graduate Assistant Ph.D}. Universidad de Los Andes. Computer Vision, 
Computational Methods, Introduction to Data Science, Physics I.\\

\years{2016.01 2017.11}\textsc{Graduate Assistant M.Sc}. Universidad de Los Andes. Experimental Physics I, 
Experimental Physics II, Basic Physics I Laboratory, Physics I,  Physics II,  Modern Optics.\\

\years{2015.01 2015.11}\textsc{Adjunct Professor}. Universidad de Los Andes. Experimental Physics I, Experimental Physics II.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\section*{Formal Education}
\years{2018.01 2023.08}\textsc{Ph.D.} in Physics, Universidad de los Andes - Bogotá, Colombia, “Artificial 
Intelligence in Astronomy: Machine Learning and Deep Learning Approaches to DESI Data".\\ Advisor: Jaime Forero-Romero.\\

\years{2015.01 2017.11}\textsc{M.Sc.} in Physics, Universidad de Los Andes - Bogot\'a, Colombia, “Experimental 
Control of frequency correlations between photon pairs from an announced individual photons source". Advisor: Mayerlín Nuñez Portela.\\

\years{2008.02 2014.11}\textsc{B.S.} in Physics (\textbf{Laureate Thesis Award}), Universidad Distrital Francisco José de Caldas - Bogotá, Colombia, “Computational software development for the study of circuits with memristive elements". Advisor: Julian Salamanca Bernal. 

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\section*{Research Experience} 
\years{2019.07 2019.12}Research Assistant, Universidad de Los Andes, Transients Project: Localize Transient 
...
\years{2020.04 Present}\textsc{Member}, \textit{ \href{https://www.desi.lbl.gov/}{Dark Energy Spectroscopic 
Instrument - DESI }} member collaborator. Data, Galaxy and Quasars Physics, Lyman Alpha, and Anomaly Detection Working Groups.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\section*{Outreach}
\years{2021.05 Present}\textsc{Member}, \textit{ \href{https://www.astroreca.org/}{ 
Red de Estudiantes Colombianos de Astronomía - RECA}}  mentorship program committee.  A program focused on guiding students in Colombia who are interested in becoming professional astronomers.\\

\years{2020.04 2021.12\\ \\2023.05 Present}\textsc{Editor and Tutor}, \textit{\href{https://github.com/DESIHIGH/desihigh}{DESI High: School of the Dark Universe}} initiative of the Educational and Public Outreach (EPO) working group, a project of DESI members focusing on introducing DESI to high schoolers through introductory notebooks written in Python Language.

\section*{Invited Research Visits}
\years{2022.08 2022.11}\textsc{Visiting Researcher}. Natural Science Research Institute, University of Seoul. Seoul, Republic of Korea.\\

\years{2022.06 2022.07}\textsc{Visiting Researcher}. Institute of Computational Cosmology, Durham University. Durham, UK.\\
...
%\noindent
%\years{2014}\textbf{Suárez, John} - Castillo, Miguel - Salamanca, Julián, “Memcircuit", Software for the study of memristive circuits, \emph{Scientific Software}, 1-2014-64122.
...
\years{2026}DESI Collaboration; \textbf{et.al.}, \href{https://iopscience.iop.org/article/10.3847/1538-3881/ae4c43/pdf}{Data Release 1 of the Dark Energy Spectroscopic Instrument}, \emph{The Astronomical Journal - AJ}$^{*}$.
\\

\years{2026}Morillo Albarrán, Carlos; \textbf{Suárez-Pérez, John F.}; Camargo-Salinas, Mónica; Miranda, Nasli; Demichela, Micaela, \href{https://www.sciencedirect.com/science/article/pii/S2590123026011370}{A multimodal human-centric ergonomic assessment framework for packaging operations}, \emph{Results in Engineering}.
\\

\years{2026}Morillo Albarrán, Carlos; Shi, Huxiao; \textbf{Suárez-Pérez, John F.}; Demichela, Micaela, \href{https://www.sciencedirect.com/science/article/pii/S0925753525002668}{Early detection of physical fatigue in industry using wearable sensors and contextual modeling}, \emph{Safety Science}.
\\

\years{2025}\textbf{Suárez-Pérez, John F.}; Gómez, Catalina; Neira, Mauricio; Hernández Hoyos, Marcela; Arbeláez, Pablo; Forero-Romero, Jaime E., \href{https://www.astroscu.unam.mx/rmaa/RMxAA..61-2/PDF/RMxAA..61-2_jsuarez-III.pdf}{Deep-TAO: The Deep Learning Transient Astronomical Object data set for Astronomical Transient Event Classification}, \emph{Revista Mexicana de Astronomía y Astrofísica - RMxAA}.
\\

\years{2025}Morillo Albarrán, Carlos; \textbf{Suárez-Pérez, John F.}; Demichela, Micaela; Camargo-Salinas, Mónica; Miranda, Nasli, \href{https://www.mdpi.com/1424-8220/25/18/5702}{Monitoring Visual Fatigue with Eye Tracking in a Pharmaceutical Packing Area}, \emph{Sensors}.
\\

\years{2025}\textbf{Suárez-Pérez, John F.}; Forero-Romero, Jaime E., \href{https://www.cambridge.org/core/journals/proceedings-of-the-international-astronomical-union/article/abs/assessing-the-quality-of-massive-spectroscopic-surveys-with-unsupervised-machine-learning/E40E4ED6D22975318BD8D11ED8E3BA32}{Assessing the Quality of Massive Spectroscopic Surveys with Unsupervised Machine Learning}, \emph{Proceedings of the International Astronomical Union, Symposium S368}.
\\

\years{2025}Morillo, Carlos A.; Demichela, Micaela; \textbf{Suárez-Pérez, John F.}; Miranda, Nasli; Camargo-Salinas, Mónica, \href{https://www.cetjournal.it/cet/25/116/005.pdf}{Exploring Wearable Devices for Enhanced Ergonomic Solutions: a Pharmaceutical Case Study}, \emph{Chemical Engineering Transactions}.
\\
\newpage
\years{2024}\textbf{Suárez-Pérez, John F.}; Camargo-Salinas, Mónica; Miranda, Nasli, \href{Suárez-Pérez, John F.; Camargo-Salinas, Mónica; Miranda, Nasli}{Implementation of Computer Vision Based Algorithms for Bio-Mechanical Risk Estimation in Upper Limbs During Activities With Repetitive Movements}, \emph{IEEE Xplore}.
\\

\years{2024}DESI Collaboration; \textbf{et.al.}, \href{https://iopscience.iop.org/article/10.3847/1538-3881/ad0b08/pdf}{Validation of the 
Scientific Program for the Dark Energy Spectroscopic Instrument}, \emph{The Astronomical Journal - AJ}\footnote[1]{As a member of the DESI collaboration, my contribution inspecting data and service time entitle me to be included as part of these publications.}.
\\

\years{2024}DESI Collaboration; \textbf{et.al.}, \href{https://arxiv.org/abs/2306.06308}{The Early Data Release of the Dark Energy Spectroscopic Instrument}, \emph{The Astronomical Journal - AJ}$^{*}$.
\\
...
\years{2026}\textbf{Suárez-Pérez, John} - Ramírez, Edgar André, “Gamified Learning Using Augmented Reality and LLM-Powered Chatbots for Teaching Kepler's Laws" - \emph{EDUCON 2026},  Cairo, Egypt, \textbf{Speaker}.\\
